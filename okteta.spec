...
cp COPYING.DOC %{buildroot}/usr/share/package-licenses/okteta/COPYING.DOC
cp COPYING.LIB %{buildroot}/usr/share/package-licenses/okteta/COPYING.LIB
pushd clr-build
%make_install
popd
%find_lang libkasten
...
/usr/share/xdg/okteta-structures.knsrc
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/okteta/COPYING
/usr/share/package-licenses/okteta/COPYING.DOC
/usr/share/package-licenses/okteta/COPYING.LIB
